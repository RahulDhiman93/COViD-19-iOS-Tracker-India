...
extension UserApi {
    ...
    func getAppInfo(callback: @escaping (_ response: [String:Any]?, _ error: Error?) -> Void) {
        
        let path = AppConstants.currentServer + "website_data.json"
    ...
    func getResources(callback: @escaping (_ response: [String:Any]?, _ error: Error?) -> Void) {
        
        let path = AppConstants.currentServer + "resources/resources.json"
